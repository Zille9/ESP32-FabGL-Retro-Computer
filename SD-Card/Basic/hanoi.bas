...
185 FOR I=1 TO 5:COL C(I),0:PRINT T$(I):P(I,0)=I:P(I,1)=0:P(I,2)=0:NEXT I
208 REM ABFRAGE ------
210 WINDOW(1,0,18,39,28,0):COL 63,0
...
520 COL 0,0:PRINT AT(A,8+V);T$(0)
530 COL C(VS),0:PRINT AT(B,8+W);T$(VS):COL 63,0
...
1220 PRINT TAB(8);"Wo soll denn das sein ?":PAUSE 1000:CLS
1230 RETURN
1500 CLS:BEEP:COL 63,0
