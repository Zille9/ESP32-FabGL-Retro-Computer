...
//*************************************************************************************
/*
void SDLprintChar(SDL_Surface *surface,char car,int x,int y,unsigned char color,unsigned char backcolor,unsigned char isDouble)
{ 
...
//*****************************************************************************************
void SDLprintText(SDL_Surface *surface,const char *cad,int x, int y, unsigned char color,unsigned char backcolor,unsigned char isDouble)
 {
...
//JJ // gb_sdl_font_6x8
  ...
  if ((auxLen>50)&&(isDouble==1))
    ...
    {
     SDLprintChar(surface,cad[i],x,y,color,backcolor,isDouble);
     x+=7;
    }
}
*/
...
void basic_loader(void) {
  ...
  if ( !SD.begin( kSD_CS, spiSD )) {                        //SD-Card starten
    ...
    cv.setBrushColor(Color::Black);   
    cv.drawText(200,320,"SD-Card Mount-Error!");
