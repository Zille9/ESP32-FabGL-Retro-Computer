...
void show_Command_Help(int was) {                                       //Anzeige eines spezifischen Befehls oder Funktion
  switch (was) {
    ...
    case KW_PRINT:
      ...
      break;
    case KW_POKE:
      Terminal.println("POKE Adress, Value");
      Terminal.println("Poke in User-RAM");
      Terminal.println("EXAMPLE: POKE 10,123");
      break;
    case KW_DIR:
    ...
    case KW_DMP:
      ...
      Terminal.println("Hexmonitor for Program 0 or PSRAM 1");
      break;
    case KW_STYLE:
...
/*    case KW_LED:
    ...
    case KW_EDIT:
      ...
      break;
    case KW_DOKE:
      Terminal.println("DOKE Adress,Word");
      Terminal.println("Save Word-Value in User-RAM");
      Terminal.println("DOKE 10,3456");
      break;
    case KW_BEEP:
    ...
    case KW_OPT:
      ...
      break;
    case KW_FPOKE:
      Terminal.println("FPOKE Adress,Val");
      Terminal.println("Save Floatvalue in User-RAM");
      Terminal.println("FPOKE 10,12.34");
      break;
    case KW_MNT:
...
void show_Function_Help(int was) {
  ...
  switch (was) {
    case FUNC_PEEK:
      Terminal.println("PEEK(Adress)");
      Terminal.println("EXAMPLE: A=PEEK(1200)");
      break;
    case FUNC_ABS:
...
/*
    ...
    case FUNC_LN:
      ...
      break;
    case FUNC_DEEK:
      Terminal.println("A=DEEK(Adress)");
      Terminal.println("reads a Word value from User-RAM");
      break;
    case FUNC_FPEEK:
      Terminal.println("A=FPEEK(Adress)");
      Terminal.println("reads a Float value from User-RAM");
      break;
    case FUNC_GPIX:
